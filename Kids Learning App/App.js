...
const App = ()=>{
  ...
  <NavigationContainer>
    <Stack.Navigator initialRouteName = "Home">
      ...
      <Stack.Screen name ="img" component={img}options={{headerShown:false,}}/>
      <Stack.Screen name ="kids" component={kids}options={{headerShown:false,}}/>
      <Stack.Screen name ="img1" component={img1}options={{headerShown:false,}}/>
      <Stack.Screen name ="Tracing" component={Tracing}options={{headerShown:false,}}/>
